	...
	<script>
		$(function(){
			$(".addToCart").click(function () {
			    ...
			    <%--location.href = "${basePath}cart?action=addItem&id=" + bookId;--%>
				$.getJSON("${basePath}cart", "action=ajaxAddItem&id=" + bookId, function (msg) {
					$("#cartTotalCount").text("您的购物车中有 " + msg.cartTotalCount + " 件商品");
					$("#cartLastName").text(msg.cartLastName);
                });
            });
		});
	</script>
